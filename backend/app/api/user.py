...
from app.database.queries.user_queries import getAllUsers, getFilteredUsers
...
@router.get("/get")
async def get_users(request: Request, search: Optional[str] = None) -> List[SimpleUser]:
    ...
    # Get Data
    rows = await getFilteredUsers(search)
